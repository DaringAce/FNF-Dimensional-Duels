...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		dimgateFlash.frames = Paths.getSparrowAtlas('dimensional_gate_flash');
		dimgateFlash.antialiasing = ClientPrefs.globalAntialiasing;
		dimgateFlash.animation.addByPrefix('bump', 'dimensional_gate_flash', 24, false);
		dimgateFlash.animation.play('bump');
		dimgateFlash.setGraphicSize(Std.int(dimgateFlash.width * 0.5));
		dimgateFlash.screenCenter();
		dimgateFlash.alpha = 0.4;
		dimgateFlash.x += 182;
		dimgateFlash.y -= 44;
...
//		gfDance.shader = swagShader.shader;
	...
	override function beatHit()
	{
		...
		if(dimgateFlash != null)
			dimgateFlash.animation.play('bump', true);
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				*/
				...
				case 15:
					deleteCoolText();
					addMoreText('Dimensional');
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Duels'); // credTextShit.text += '\nFunkin';
