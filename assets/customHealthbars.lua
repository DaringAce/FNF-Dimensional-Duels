...
function onCreatePost()
    ...
    setProperty("healthbarUnder.x", getProperty("healthbackground.x")+(getProperty('healthbackground.width')/2)-(getProperty('healthbarUnder.width')/2)+innerBarX)
    setProperty("healthbarUnder.y", getProperty("healthbackground.y")+(getProperty('healthbackground.height')/2)-(getPropety('healthbarUnder.height')/2)+innerBarY)
...
function onUpdatePost(elapsed)
    if shit then
        setProperty("iconP2.y", getProperty('healthbarOver.y')+(getProperty("iconP2.height")/10)-(originalP2height)/2)+iconY2-30)
        setProperty("iconP1.y", getProperty('healthbarOver.y')+(getProperty("iconP1.height")/10)-(originalP1height)/2)+iconY1-30)
    else
        setProperty("iconP2.y", getProperty('healthbarOver.y')+(getProperty("iconP2.height")/10)-(originalP2height)/2)+iconY2-8000)
        setProperty("iconP1.y", getProperty('healthbarOver.y')+(getProperty("iconP1.height")/10)-(originalP1height)/2)+iconY1-8000)
    end
    if flipped then
