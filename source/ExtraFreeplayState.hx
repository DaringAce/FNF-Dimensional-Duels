...
class ExtraFreeplayState extends MusicBeatState
{
	...
	{
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('extrafreeplaySonglist'));
		 ...
		 */
		 ...
		 DiscordClient.changePresence("In the Extras Freeplay Menu", null);
		 #end
