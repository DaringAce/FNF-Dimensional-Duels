...
--[[
    ...
    V2: Added a "cinematic bars" toggle!
    V2h [CURRENT / HOTFIX]: Made it compatible with playback rates
]]
...
function onBeatHit()
    ...
    if toggle == 1 then
        ...
        triggerEvent("Add Camera Zoom", 0.015 * intensity, 0.03 * intensity); -- intensity affects this now
    end
end

function onTweenCompleted(tag)
    if tag == 'YHUD1' then
        doTweenY('YHUD2', 'camHUD', 0, (Cro / playbackRate) * 0.5, "cubeIn");
    end
    for i = 1, 2 do
