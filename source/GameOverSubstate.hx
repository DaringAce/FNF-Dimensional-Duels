...
class GameOverSubstate extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float, camX:Float, camY:Float)
	{
		...
		*/
		...
		if(invalidChar)
		{
			...
			retryText = new FlxSprite().loadGraphic(Paths.image("lose"));
			retryText.frames = Paths.getSparrowAtlas("lose");
	...
	function coolStartDeath(?volume:Float = 1):Void
	{
		...
		if(retryText != null)
		{
			...
			retryText.alpha = 0;
			retryText.loadGraphic(Paths.image("restart"));
